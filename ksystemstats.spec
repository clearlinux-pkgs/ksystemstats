...
Version  : 5.27.6
Release  : 36
URL      : https://download.kde.org/stable/plasma/5.27.6/ksystemstats-5.27.6.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.6/ksystemstats-5.27.6.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.6/ksystemstats-5.27.6.tar.xz.sig
...
%prep
%setup -q -n ksystemstats-5.27.6
cd %{_builddir}/ksystemstats-5.27.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1687292574
mkdir -p clr-build
pushd clr-build
