...
Version  : 5.26.1
Release  : 23
URL      : https://download.kde.org/stable/plasma/5.26.1/ksystemstats-5.26.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.26.1/ksystemstats-5.26.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.1/ksystemstats-5.26.1.tar.xz.sig
...
%prep
%setup -q -n ksystemstats-5.26.1
cd %{_builddir}/ksystemstats-5.26.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666290341
mkdir -p clr-build
pushd clr-build
