...
Version  : 6.1.0
Release  : 50
URL      : https://download.kde.org/stable/plasma/6.1.0/ksystemstats-6.1.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.0/ksystemstats-6.1.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.0/ksystemstats-6.1.0.tar.xz.sig
...
%setup -q -n ksystemstats-6.1.0
cd %{_builddir}/ksystemstats-6.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718830790
mkdir -p clr-build
pushd clr-build
