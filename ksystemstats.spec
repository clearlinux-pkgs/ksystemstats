...
Version  : 5.26.2
Release  : 24
URL      : https://download.kde.org/stable/plasma/5.26.2/ksystemstats-5.26.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.26.2/ksystemstats-5.26.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.2/ksystemstats-5.26.2.tar.xz.sig
...
%prep
%setup -q -n ksystemstats-5.26.2
cd %{_builddir}/ksystemstats-5.26.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667248257
mkdir -p clr-build
pushd clr-build
