...
Source0  : https://download.kde.org/stable/plasma/6.1.3/ksystemstats-6.1.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.3/ksystemstats-6.1.3.tar.xz.sig
...
%setup -q -n ksystemstats-6.1.3
cd %{_builddir}/ksystemstats-6.1.3
pushd ..
cp -a ksystemstats-6.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721166869
mkdir -p clr-build
pushd clr-build
