...
Version  : 6.0.0
Release  : 41
URL      : https://download.kde.org/stable/plasma/6.0.0/ksystemstats-6.0.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.0/ksystemstats-6.0.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.0/ksystemstats-6.0.0.tar.xz.sig
...
%prep
%setup -q -n ksystemstats-6.0.0
cd %{_builddir}/ksystemstats-6.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709346231
mkdir -p clr-build
pushd clr-build
