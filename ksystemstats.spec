...
Source0  : https://download.kde.org/stable/plasma/6.1.4/ksystemstats-6.1.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.4/ksystemstats-6.1.4.tar.xz.sig
...
%setup -q -n ksystemstats-6.1.4
cd %{_builddir}/ksystemstats-6.1.4
pushd ..
cp -a ksystemstats-6.1.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723152695
mkdir -p clr-build
pushd clr-build
