...
Source0  : https://download.kde.org/stable/plasma/6.0.5/ksystemstats-6.0.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.5/ksystemstats-6.0.5.tar.xz.sig
...
%setup -q -n ksystemstats-6.0.5
cd %{_builddir}/ksystemstats-6.0.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716401622
mkdir -p clr-build
pushd clr-build
