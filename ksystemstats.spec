...
Version  : 6.0.3
Release  : 46
URL      : https://download.kde.org/stable/plasma/6.0.3/ksystemstats-6.0.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.3/ksystemstats-6.0.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.3/ksystemstats-6.0.3.tar.xz.sig
...
%prep
%setup -q -n ksystemstats-6.0.3
cd %{_builddir}/ksystemstats-6.0.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711656822
mkdir -p clr-build
pushd clr-build
