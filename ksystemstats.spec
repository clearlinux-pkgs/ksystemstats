...
Version  : 6.3.4
Release  : 66
URL      : https://download.kde.org/stable/plasma/6.3.4/ksystemstats-6.3.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.4/ksystemstats-6.3.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.4/ksystemstats-6.3.4.tar.xz.sig
...
%setup -q -n ksystemstats-6.3.4
cd %{_builddir}/ksystemstats-6.3.4
pushd ..
cp -a ksystemstats-6.3.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744144609
mkdir -p clr-build
pushd clr-build
