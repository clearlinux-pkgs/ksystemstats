...
Version  : 5.27.9
Release  : 39
URL      : https://download.kde.org/stable/plasma/5.27.9/ksystemstats-5.27.9.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.9/ksystemstats-5.27.9.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.9/ksystemstats-5.27.9.tar.xz.sig
...
%prep
%setup -q -n ksystemstats-5.27.9
cd %{_builddir}/ksystemstats-5.27.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698290832
mkdir -p clr-build
pushd clr-build
