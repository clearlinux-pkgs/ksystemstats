...
Source0  : https://download.kde.org/stable/plasma/6.0.4/ksystemstats-6.0.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.4/ksystemstats-6.0.4.tar.xz.sig
...
%setup -q -n ksystemstats-6.0.4
cd %{_builddir}/ksystemstats-6.0.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713301385
mkdir -p clr-build
pushd clr-build
