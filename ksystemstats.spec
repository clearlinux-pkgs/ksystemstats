...
Version  : 5.27.7
Release  : 37
URL      : https://download.kde.org/stable/plasma/5.27.7/ksystemstats-5.27.7.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.7/ksystemstats-5.27.7.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.7/ksystemstats-5.27.7.tar.xz.sig
...
%prep
%setup -q -n ksystemstats-5.27.7
cd %{_builddir}/ksystemstats-5.27.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1690903287
mkdir -p clr-build
pushd clr-build
