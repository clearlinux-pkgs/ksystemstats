...
Version  : 6.3.0
Release  : 62
URL      : https://download.kde.org/stable/plasma/6.3.0/ksystemstats-6.3.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.0/ksystemstats-6.3.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.0/ksystemstats-6.3.0.tar.xz.sig
...
%setup -q -n ksystemstats-6.3.0
cd %{_builddir}/ksystemstats-6.3.0
pushd ..
cp -a ksystemstats-6.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739304760
mkdir -p clr-build
pushd clr-build
