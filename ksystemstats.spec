...
Version  : 5.27.8
Release  : 38
URL      : https://download.kde.org/stable/plasma/5.27.8/ksystemstats-5.27.8.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.8/ksystemstats-5.27.8.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.8/ksystemstats-5.27.8.tar.xz.sig
...
%prep
%setup -q -n ksystemstats-5.27.8
cd %{_builddir}/ksystemstats-5.27.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694548438
mkdir -p clr-build
pushd clr-build
