...
Version  : 6.1.1
Release  : 51
URL      : https://download.kde.org/stable/plasma/6.1.1/ksystemstats-6.1.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.1/ksystemstats-6.1.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.1/ksystemstats-6.1.1.tar.xz.sig
...
%setup -q -n ksystemstats-6.1.1
cd %{_builddir}/ksystemstats-6.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719434492
mkdir -p clr-build
pushd clr-build
